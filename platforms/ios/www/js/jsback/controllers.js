...
.controller('ConsultaRapidaCtrl', function($scope, $rootScope, API, Usuario) {
  ...
  $rootScope.pesquisaRapida = [
    { 'nome':'MGTe',   'icone':'img/icones/icone-mgte.png',   'wIcone':100, 'url':API.url+'api/v1/mgt3',     'tabelaValor':'AnimalAGCriador',  'campoValor':'mgt',     'tabelaAcuracia':'AnimalAGCriador',  'campoAcuracia':'amgt',    'tabelaTop':'AnimalAGCriador4',  'campoTop':'mgt' },
    ...
    { 'nome':'MP210',  'icone':'img/icones/icone-mp210.png',  'wIcone':100, 'url':API.url+'api/v1/dmpp240m', 'tabelaValor':'AnimalAGCriador',  'campoValor':'dmpp240', 'tabelaAcuracia':'AnimalAGCriador',  'campoAcuracia':'ampp240', 'tabelaTop':'AnimalAGCriador4', 'campoTop':'dmpp240' },
    ...
    { 'nome':'DMAC',   'icone':'img/icones/icone-dmac.png',   'wIcone':100, 'url':API.url+'api/v1/mac',      'tabelaValor':'AnimalAGCriador', 'campoValor':'ddmac',   'tabelaAcuracia':'AnimalAGCriador', 'campoAcuracia':'admac',   'tabelaTop':'AnimalAGCriador4', 'campoTop':'ddmac' },
    ...
    { 'nome':'DCAR',   'icone':'img/icones/icone-dcar.png',   'wIcone':100, 'url':API.url+'api/v1/car',      'tabelaValor':'AnimalAGCriador', 'campoValor':'ddcar',   'tabelaAcuracia':'AnimalAGCriador', 'campoAcuracia':'adcar',   'tabelaTop':'AnimalAGCriador4', 'campoTop':'ddcar' },
    { 'nome':'DIMS',   'icone':'img/icones/icone-dims.png',   'wIcone':100, 'url':API.url+'api/v1/ims',      'tabelaValor':'AnimalAGCriador', 'campoValor':'ddims',   'tabelaAcuracia':'AnimalAGCriador', 'campoAcuracia':'adims',   'tabelaTop':'AnimalAGCriador4', 'campoTop':'ddims' },
