        ...
        return {
            ...
            controller: ['$attrs', '$timeout', '$scope', function ($attrs, $timeout, $scope) {
                ...
                $timeout(function () {
                    ...
                    controller.selectItemsLabel = valueOrDefault(controller.selectItemsLabel, "Selecione um animal...");
                    controller.selectedItemsLabel = valueOrDefault(controller.selectedItemsLabel, $interpolate("Animais selecionado(s) {{maxSelectedItems ? ' (max. ' + maxSelectedItems + ')' : ''}}:")(controller));
