    ...
    function ($ionicBackdrop, $ionicScrollDelegate, $document, $q, $parse, $interpolate, $ionicPlatform, $compile, $templateRequest) {
        return {
            ...
            controller: ['$attrs', '$timeout', '$scope', function ($attrs, $timeout, $scope) {
                ...
                $timeout(function () {
                    controller.placeholder = valueOrDefault(controller.placeholder, 'Clique e comece a digitar...');
                    controller.cancelLabel = valueOrDefault(controller.cancelLabel, 'OK');
                    controller.selectItemsLabel = valueOrDefault(controller.selectItemsLabel, "Selecione um produto/marca...");
                    controller.selectedItemsLabel = valueOrDefault(controller.selectedItemsLabel, $interpolate("Produto/marca selecionado {{maxSelectedItems ? ' (max. ' + maxSelectedItems + ')' : ''}}:")(controller));
