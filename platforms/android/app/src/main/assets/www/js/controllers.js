...
.controller('AppCtrl', function($scope, $state, $localStorage, $ionicPopup, $ionicHistory, Usuario, $http, API) {
  ...
  $scope.lerPDF = function(){
    ...
    $http.post(API.url+'/api/v1/ler_pdf_url',pdf, function(sucesso){
      console.log(sucesso);
      $http.post(API.url+'/api/v1/ler_pdf_diretorio',pdf, function(sucesso2){
...
.controller( 'ConsultaPorNomeCtrl', function($scope, $state, $rootScope, $state, $ionicHistory, $ionicLoading, 
  $stateParams, $localStorage, $ionicLoading, $http, $ionicModal, $ionicPopup, API, Usuario, $cordovaBarcodeScanner) {
//aqui
